  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <h1 className="font-script text-6xl text-primary">404</h1>
  ...
  head: () => ({
    meta: [
      ...
      { title: "Pétalos Floristas · Arte Floral en Alcalá de Henares" },
      {
        name: "description",
        content:
          "Floristería familiar en Alcalá de Henares: ramos, plantas, rosas eternas y entrega propia en Madrid y Guadalajara.",
      },
      { name: "author", content: "Floristería Pétalos Alcalá" },
    ...
    links: [
      ...
      { rel: "apple-touch-icon", href: "/favicon-256x256.png" },
    ],
  }),
